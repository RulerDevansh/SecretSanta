        ...
        <form onSubmit={onSubmit} className="space-y-4">
          <label className="block text-sm font-semibold text-holly-600">
            ...
            <input
              ...
              className="mt-2 w-full rounded-2xl border border-holly-200 bg-holly-50 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-holly-400"
            />
          </label>
          ...
          <div className="flex justify-end gap-3">
            ...
            <button type="submit" className="rounded-2xl px-4 py-2 bg-holly-600 text-white font-semibold">
              {submitText}
            </button>
          </div>
        </form>
